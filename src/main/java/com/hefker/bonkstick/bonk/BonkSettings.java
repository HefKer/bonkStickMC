 ...
 * @param respectPvp whether players stop being Bonkable when the server has PvP turned off
 */
public record BonkSettings(double strength, boolean respectKnockbackResistance, boolean respectPvp) {
	...
	public static final boolean DEFAULT_RESPECT_PVP = false;

	public static final BonkSettings DEFAULTS =
			new BonkSettings(DEFAULT_STRENGTH, DEFAULT_RESPECT_KNOCKBACK_RESISTANCE, DEFAULT_RESPECT_PVP);
